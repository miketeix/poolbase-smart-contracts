...
module.exports = async function(callback) {
  ...
  const gustavoCoinInstance = new web3.eth.Contract(tokenArtifact.abi, gustavoCoinAddress, {
  ...
  const receipt = await gustavoCoinInstance.methods.mint(poolContractAddress, web3.utils.toWei('400')).send();
